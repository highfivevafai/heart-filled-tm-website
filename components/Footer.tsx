...
const Footer = () => {
  return (
    <footer>
      {/* First Part: Logo, Links, Social Media - White Background */}
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-8 py-8 md:pt-14">
          <div className="grid grid-cols-1 lg:grid-cols-4 items-center gap-4 md:gap-8">
            ...
            <nav className="flex justify-center lg:col-span-2">
              <ul className="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm md:text-base text-slate-700 hover:text-slate-900 ">
                <li>
                ...
                <li>
                  <Link href="/about" className="transition font-medium">
                    About
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/visit-our-club" className=" transition font-medium">
                    Visit Our Club
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex items-center justify-center lg:justify-end gap-4 flex-shrink-0">
              <a
                href="https://www.facebook.com/heartfilledtoastmasters/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-700 hover:text-slate-900 transition"
                aria-label="Facebook"
              >
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 md:w-7 md:h-7 fill-current">
                  <title>Facebook</title>
                  <path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 26.805 26.805 0 0 0-.733-.009c-.707 0-1.259.096-1.675.309a1.686 1.686 0 0 0-.679.622c-.258.42-.374.995-.374 1.752v1.297h3.919l-.386 2.103-.287 1.564h-3.246v8.245C19.396 23.238 24 18.179 24 12.044c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.628 3.874 10.35 9.101 11.647Z"/>
                </svg>
              </a>
              <a
                href="https://www.meetup.com/heart-filled-toastmasters/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-700 hover:text-slate-900 transition"
                aria-label="Meetup"
              >
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 md:w-8 md:h-8 fill-current">
                  <title>Meetup</title>
      ...
      {/* Second Part: Club Info and Links - White Background */}
      <div className="bg-white">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-center md:text-left">
              <p className="text-sm md:text-base text-gray-600 font-medium">
                Heart Filled Toastmasters, CLUB #07619175, 52, Area B21
              </p>
            </div>

            {/* Privacy and Accessibility Links - Far Right */}
            <div className="flex items-center gap-6">
              <Link 
                href="/privacy" 
                className="text-sm md:text-base text-gray-600 hover:text-gray-700 transition font-medium"
              >
                Privacy
              </Link>
              <Link 
      ...
      {/* Third Part: Disclaimer - Dark Background */}
      <div className="bg-slate-900">
        <div className="max-w-7xl mx-auto px-8 py-6">
          <p className="text-xs md:text-xs text-center text-gray-300 leading-relaxed">
            The information on this website is for the sole use of Toastmasters&apos; members, 
            for Toastmasters business only. It is not to be used for solicitation and distribution 
